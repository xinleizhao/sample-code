...
from __future__ import print_function import sys import copy import pprint 
prev_value = {} 
prev_time = {} 
prev_bps = {} 
...
def interface_bytes_to_bps(index_name, direction, bytes_counter, **kwargs): 
    ...
    cur_time = kwargs.get('point_time', 0) bytes_counter = int(bytes_counter) 
    # convert bytes into bits 
    # bps = (bytes * 8) bits_counter = bytes_counter * 8 
